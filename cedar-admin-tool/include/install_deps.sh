...
until [ "$n" -ge 5 ]
do
  mvn org.apache.maven.plugins:maven-dependency-plugin:3.5.0:get -DrepoUrl=${CEDAR_MAVEN_REPO_URL:-https://nexus.bmir.stanford.edu}/ -Dartifact=org.metadatacenter:${ARTIFACT}:${CEDAR_VERSION} -Dmaven.wagon.http.retryHandler.count=5 && break
